...
class ISearchWechatStep(IBaseChatPipelineStep):
    class InstanceSerializer(serializers.Serializer):
        ...
        # 需要查询的条数
        wechat_name = serializers.CharField(required=True,
                                            error_messages=ErrMessage.integer("微信名称"))
        # 相似度 0-1之间
    ...
    def execute(self, problem_text: str, dataset_id_list: list[str], exclude_document_id_list: list[str],
                ...
                search_mode: str = None, wechat_name=None,
